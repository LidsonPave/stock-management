...
def generate_general_pdf(
    ...
    resumo = [
        ...
        ['Produtos cadastrados', str(total_products)],

        ['Itens em estoque', str(total_stock)],

        ['Investimento', f'{total_investment:,.2f} MT'],

        ['Total de vendas', f'{total_sales:,.2f} MT'],

        ['Saídas do caixa', f'{total_withdrawals:,.2f} MT'],

        ['Saldo', f'{(total_sales-total_withdrawals):,.2f} MT']
